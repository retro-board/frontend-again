...
export const useEnvironment = () => useBreadcrumbStore((state) => state.environment);
export const useSecretMenu = () => useBreadcrumbStore((state) => state.secretMenu);
export const useCommitHash = () => useBreadcrumbStore((state) => state.commitHash);

// Action selectors
export const useBreadcrumbActions = () => useBreadcrumbStore((state) => ({
